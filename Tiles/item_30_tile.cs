...
{
    internal class item_30_tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "prueba/Content/Tiles/item_30_relic";

        public override string Texture => "prueba/Content/Tiles/RelicPedestal";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<Items.Placeable.item_10>();
                    break;
