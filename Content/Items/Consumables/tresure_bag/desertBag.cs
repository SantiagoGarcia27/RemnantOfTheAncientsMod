...
namespace RemnantOfTheAncientsMod.Content.Items.Consumables.tresure_bag
{
    ...
    {
        public bool CanDrop(DropAttemptInfo info) => !Main.LocalPlayer.GetModPlayer<ReaperPlayer>().SoulsUpgrades[RemnantOfTheAncientsMod.RemnantOfTheAncients][NPCType<DesertAniquilator>()] && Reaper.ReaperMode;
