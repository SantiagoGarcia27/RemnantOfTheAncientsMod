...
namespace RemnantOfTheAncientsMod.Content.Projectiles.Summon.Whips
{
	public class TrueDurendalProjectile : ModProjectile
	{
         ...
         public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Main.player[Projectile.owner].ownedProjectileCounts[ModContent.ProjectileType<ExcaliburMinion>()] < 1) Projectile.NewProjectile(Projectile.GetSource_FromAI(), target.position + new Vector2(0,-6*16), Vector2.One, ModContent.ProjectileType<ExcaliburMinion>(), damageDone, hit.Knockback, Main.myPlayer); ;
            ...
            Projectile.damage = (int)(damageDone * 0.9f); 
        }
