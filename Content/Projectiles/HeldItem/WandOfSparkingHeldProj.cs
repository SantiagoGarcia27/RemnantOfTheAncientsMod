...
namespace RemnantOfTheAncientsMod.Content.Projectiles.HeldItem
{
    ...
    public class WandOfSparkingHeldProj : ModProjectile
	{
        ...
        public override bool PreDraw(ref Color lightColor)
		{
            ...
            if (player.whoAmI == Main.myPlayer)
            {
                var texture = ModContent.Request<Texture2D>("RemnantOfTheAncientsMod/Content/Effects/MagicCircle/MagicCircleCenter_2");
                ...
                Color colorBase = player.HeldItem.type == ItemID.WandofSparking? Color.Orange : Color.Cyan;
