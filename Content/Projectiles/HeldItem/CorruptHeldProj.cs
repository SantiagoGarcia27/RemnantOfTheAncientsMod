...
namespace RemnantOfTheAncientsMod.Content.Projectiles.HeldItem
{
    ...
    public class CorruptRayHeldProj : ModProjectile
	{
        ...
        public override bool PreDraw(ref Color lightColor)
		{
            ...
            if (player.whoAmI == Main.myPlayer)
            {
                var texture = ModContent.Request<Texture2D>("RemnantOfTheAncientsMod/Content/Effects/MagicCircle/MagicCircleCenter_4");
                ...
                {
                    Color color = new Color(Color.Purple.R, Color.Purple.G, Color.Purple.B, 20) * fade;
