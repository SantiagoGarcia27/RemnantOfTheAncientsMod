...
{
    public abstract class  CickerSwingProjectile : ModProjectile
    {
        ...
        string getTexture()
        {
            if (Owner != null && ItemLoader.GetItem(itemBaseType) != null)
                return ItemLoader.GetItem(itemBaseType).Texture;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                target.AddBuff(ModContent.BuffType<CurseMarkBuff>(), 300);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>(getTexture()).Value;//TextureAssets.Projectile[Type].Value;


            Main.spriteBatch.Draw(texture, Projectile.Center - Main.screenPosition, default, lightColor * Projectile.Opacity, Projectile.rotation + rotationOffset, origin, Projectile.scale, effects, 0);

            /*SpriteBatch spriteBatch = Main.spriteBatch;
            Texture2D texture = ModContent.Request<Texture2D>(getTexture()).Value;
            spriteBatch.Draw(texture, Projectile.Center - Main.screenPosition, null, Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);*/
...
public class GravediggersSickleSwingProjectile : CickerSwingProjectile
{
...
public class NightLotusSickleSwingProjectile : CickerSwingProjectile
{
