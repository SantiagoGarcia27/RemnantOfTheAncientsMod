...
namespace RemnantOfTheAncientsMod.Common.ModCompativilitie.InfernumBossIntroScreen
{
    ...
    public abstract class BaseIntroScreenTitle
    {
        ...
        protected LocalizedText GetLocalizedText(string key)
        {
            ...
            return Language.GetOrRegister(RemnantOfTheAncientsMod.RemnantOfTheAncients.GetLocalizationKey(localizationKey));
        }
        ...
        public void Update()
        {
            ...
            if (!ShouldBeActive() /*|| !RemnantOfTheAncientsMod.InfernumMod.CanUseCustomAIs || !InfernumConfig.Instance.BossIntroductionAnimationsAreAllowed*/)
            {
                AnimationTimer = 0;
