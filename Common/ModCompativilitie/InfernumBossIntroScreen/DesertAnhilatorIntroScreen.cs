...
namespace RemnantOfTheAncientsMod.Common.ModCompativilitie.InfernumBossIntroScreen
{
    ...
    public class DesertAnhilatorIntroScreen : BaseIntroScreenTitle
    {
        public override TextColorData TextColor => new(completionRatio =>
        {
            ...
            Color light = Color.Lerp(Color.Brown, Color.SandyBrown, 0.65f);
        ...
        public override bool ShouldBeActive() => NPC.AnyNPCs(ModContent.NPCType<DesertAniquilator>()) &&SangarUtilities.Common.DificultyUtils.InfernumMode;
