...
namespace RemnantOfTheAncientsMod.Common.GlobalInfoDisplay
{
    ...
    public class MaxMinionsDisplay : InfoDisplay
	{
        ...
        public override string DisplayValue(ref Color displayColor, ref Color displayShadowColor)/* tModPorter Suggestion: Set displayColor to InactiveInfoTextColor if your display value is "zero"/shows no valuable information */ => $"{Main.LocalPlayer.maxMinions} minions.";
    }
    public class MaxSentryDisplay : InfoDisplay
    {
        ...
        public override string DisplayValue(ref Color displayColor, ref Color displayShadowColor)/* tModPorter Suggestion: Set displayColor to InactiveInfoTextColor if your display value is "zero"/shows no valuable information */ => $"{Main.LocalPlayer.maxTurrets} turrets.";
    }
    public class DamageReductionDisplay : InfoDisplay
    {
        ...
        public override string DisplayValue(ref Color displayColor, ref Color displayShadowColor)/* tModPorter Suggestion: Set displayColor to InactiveInfoTextColor if your display value is "zero"/shows no valuable information */ => $"{Main.LocalPlayer.endurance * 100}% Damage Reduction";
    }
