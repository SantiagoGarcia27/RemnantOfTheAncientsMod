...
namespace RemnantOfTheAncientsMod.Common.UI.FargosUI
{
    ...
    internal class NightTpCouldownBar : UIState
	{
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(ModContent.Request<Texture2D>("RemnantOfTheAncientsMod/Common/UI/FargosUI/NightTpCouldownBarFrame")); // Frame of our resource bar
			...
			text.Width.Set(200, 0f);//138
			text.Height.Set(34, 0f);
			text.Top.Set(40, 0f);
			text.Left.Set(0, 0f);

			gradientA = new Color(44, 42, 92); // A dark purple
			gradientB = new Color(141, 129, 233); // A light purple
	...
	internal class NightCouldownUISystem : ModSystem
	{
		...
		internal NightTpCouldownBar CouldownBar;
